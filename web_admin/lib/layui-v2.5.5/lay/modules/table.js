...
function(e) {
    ...
    j.prototype.config = {
        ...
        loading: !0,
        cellMinWidth: 60,
        defaultToolbar: ["filter", "exports","exports_data", "print"],
        autoSort: !0,
        text: {
            none: "无数据"
        }
        ...
        if (i.totalRow) {
            ...
            t.eachCols(function(e, n) {
                ...
                r = function() {
                    ...
                    t = "<span style='"+n.valueStyle+"'>"+(parseFloat(a[o])/n.calculation).toFixed(n.decimal==undefined?2:n.decimal)+"<span>"
						+"<span style='"+n.labelStyle+"'>"+(n.label==undefined?'':n.label)+"</span>",
                    i = {};
                    return i[o] = t,
                    t = u(n, t, i),
                    n.totalRow ? t || e: e
        ...
        function(e) {
            ...
            case "LAYTABLE_EXPORT":
                r.ie ? l.tips("导出功能不支持 IE，请用 Chrome 等高级浏览器导出", this, {
                    ...
                    list: function() {
                        return ['<li data-type="csv">(layui默认)导出到Csv文件</li>', 
						'<li data-type="xls">(layui默认)导出到 Excel 文件</li>'].join("")
                    } (),
                    done: function(e, l) {
                        l.on("click",
                        function() {
			...
			case "exports_data":
                s({list: function() {
                    return ['<li layEvent="exp_excel" data-type="xls">导出到Excel</li>',
					'<li layEvent="exp_xml" data-type="xml">导出到XML</li>'].join("");
                }(),
				done: function(e, l) {
                    l.on("click",function() {
						...
						var l = layui.layer;
						var exp=table.exp;
						if(exp == undefined || exp == '' || exp == null){l.msg('未定义导出参数!');return;}
						var param = "?key_name="+exp.key
						...
						//跳转
						window.location.href=exp.url+param;
                    })
                }});
                break;
            case "LAYTABLE_PRINT":
