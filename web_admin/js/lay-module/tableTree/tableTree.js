    ...
    TableTree.prototype = {
        ...
        ,createChildren:function(arr,field,tr,lvl){
            ...
            _layui.each(arr,function (key,item) {
                ...
                if(item.child){
                    ...
                    that.createChildren(item.child,field,nextTr,lvl+1)
                }
            });
        }
            ...
            for(var i=0;i<arr.length;i++){
                ...
                if(uniqueTreeid+"" === item[treeid]+""){
                    ...
                    if (item.child && item.child.length>0) {
                       var data = this.findChildren(item.child, uniqueTreeid);
                       if(data) return  data;
                    }
                }
            }
        ...
        ,asyncAddTree:function (obj,data,tr,lvl) {
            ...
            obj.forEach(function (e) {
                ...
                if(e.child && e.child.length>0){
                    that.asyncAddTree(e.child,e,tr.next(),lvl+1);
                }
            });
        ...
        ,clearChildCacheData:function (list,uniqueTreeid) {
            ...
            for(var i=0;i<list.length;i++){
                ...
                if((uniqueTreeid+"") === (item[treeid]+"")) {
                    ...
                    if(item.child && item.child.length > 0){
                        this.clearChildCacheData(item.child,uniqueTreeid)
                    }
                }
            }
        }
        ...
        deleteLayTableIndex:function (data) {
            ...
            data.forEach(function (e) {
                ...
                if(e.child){
                    that.deleteLayTableIndex(e.child);
                }
            })
        },
