layui.define(['layer', 'carousel'], function (exports) {
    ...
    var renderDom = function (elem, stepItems, postion) {
        ...
        for (var i = 0; i < stepItems.length; i++) {
            ...
            if (i == postion) {
                stepDiv += '<div class="step-item-head step-item-head-active" id="'+id+'"><i class="layui-icon">' + number + '</i></div>';
            } else if (i < postion) {
                stepDiv += '<div class="step-item-head"><i class="layui-icon layui-icon-ok"></i></div>';
            } else {
                stepDiv += '<div class="step-item-head " id="'+id+'"><i class="layui-icon">' + number + '</i></div>';
            }
