        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="http://47.106.198.137:81/ow/" target="_blank"><i class="layui-icon layui-icon-theme"></i>官方网站</a>\n' +
					'<a class="more-menu-item" href="http://47.106.198.137:81/uploadFiles/publics/机构管理后台操作指南.pdf" target="_blank"><i class="layui-icon layui-icon-theme"></i>操作手册</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
